...
SOURCE_MANIFEST: dict[str, ModelSource] = {
    ...
    "sam2.1-hiera-large": ModelSource(
        ...
        access_status="open",
        known_blockers=[
            "SAM 2.1 official HF checkpoint name to verify on facebook namespace.",
            "Engine not yet wired with the 2.1-specific config.",
        ],
        recommended_action="audit_only",
    ),
    ...
    "medsam": ModelSource(
        ...
        access_status="open",
        domain="medical",
        known_blockers=["Medical use review required. Engine not yet wired."],
        recommended_action="expert_sidecar",
    ),
    "medsam2": ModelSource(
        model_id="medsam2",
