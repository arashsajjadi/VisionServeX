...
_EXTENDED_ROWS: list[ModelSource] = [
    ...
    *[
        ...
        for mid, fam, repo, lic, risk, action, note in (
            (
                ...
                "non_commercial",
                "external_restricted_baseline",
                "EdgeSAM is NTU S-Lab License 1.0 (NON-COMMERCIAL); external baseline only.",
            ),
            (
                "efficientsam",
                "efficientsam",
            ...
            (
                ...
                "Apache-2.0 (HQSeg-44K training data partly non-commercial)",
                "review",
                "expert_sidecar",
                "HQ-SAM: Apache-2.0 code/weights but HQSeg-44K training data partly non-commercial; review.",
            ),
            (
                "mobilesam",
                "mobilesam",
    ...
    *[
    ...
    ModelSource(
        ...
        notes="AgriCLIP is CC-BY-4.0 (commercial OK with attribution); verified by deep-research audit.",
    ),
    ModelSource(
