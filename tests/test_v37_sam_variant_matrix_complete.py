...
VALID = {"benchmark_passed", "auth_required", "checkpoint_required", "sidecar_required",
         "legal_review_required", "excluded_restricted", "not_released", "blocked_documented",
         "external_api_only"}

REQUIRED_VARIANTS = [
    "sam-vit-b", "sam-vit-l", "sam-vit-h", "sam-vit-b-onnx", "sam-vit-l-onnx", "sam-vit-h-onnx",
    "mobilesam", "mobilesam-onnx", "efficientsam-l0", "efficientsam-l1", "efficientsam-l2",
    "efficientsam-onnx", "sam2-hiera-tiny", "sam2-hiera-small", "sam2-hiera-base-plus",
    "sam2-hiera-large", "sam2.1-hiera-tiny", "sam2.1-hiera-small", "sam2.1-hiera-base-plus",
    "sam2.1-hiera-large", "sam2.1-video-tiny", "sam2.1-video-small", "sam2.1-video-base-plus",
    "sam2.1-video-large", "sam2.1-onnx-tiny", "sam2.1-onnx-small", "sam2.1-onnx-base-plus",
    "sam2.1-onnx-large", "medsam", "medsam2", "hq-sam", "hq-sam2", "light-hq-sam", "tinysam",
    "q-tinysam", "edgesam", "sam3-base", "sam3-image", "sam3-video", "sam3-text-prompt",
    "sam3-visual-prompt", "sam3-exemplar-prompt", "sam3-open-vocabulary", "sam3-tracking",
...
def test_benchmark_passed_have_real_artifacts():
    for vid, r in _rows().items():
        if r["final_state"] == "benchmark_passed" and r["evidence_artifact"]:
            assert r["artifact_exists"] == "True", f"{vid}: artifact missing {r['evidence_artifact']}"
